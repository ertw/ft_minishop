...
function get_product_name($id) {
	$query = 'select productname from minishop_db.products where id = $1 limit 1';
	$result = pg_query_params($query, array($id));
	$products = pg_fetch_result($result, 0);
	return $products;
}

function get_product_price($id) {
	$query = 'select price from minishop_db.products where id = $1 limit 1';
	$result = pg_query_params($query, array($id));
	$products = pg_fetch_result($result, 0);
	return $products;
}
